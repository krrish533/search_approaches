...
class DenseRetriever:
    ...
    def search(self, query):
        ...
        docs = [match.metadata.get("context", "") or match.metadata.get("summary", "") for match in matches]
        ...
        # Normalize doc_id for metadata lookup
        base_id = best_doc_id
        ...
        try:
            with open(metadata_path, "r", encoding="utf-8") as f:
                ...
                doc_text = metadata.get("context", "") or metadata.get("summary", "")
        ...
        return {
            ...
            "score": best_rerank_score if best_rerank_score is not None else best_relevance_score,
